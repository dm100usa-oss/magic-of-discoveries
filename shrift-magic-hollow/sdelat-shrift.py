...
SRC='/home/claude/fnt/fredoka/fredoka-latin-700-normal.ttf'
SLANT=0.30   # наклон черточки ударения
OUT='/home/claude/out-font/MagicHollow-Regular.ttf'
S=1000                 # пикселей на кегельную площадку при обводке
RING_REL=0.0333        # толщина контура по отношению к высоте прописной буквы
...
def build():
    ...
    fb.setupNameTable({
        'familyName':'Magic Hollow',
        'styleName':'Regular',
        'uniqueFontIdentifier':'MagicHollow-Regular 1.000',
        'fullName':'Magic Hollow Regular',
        'psName':'MagicHollow-Regular',
