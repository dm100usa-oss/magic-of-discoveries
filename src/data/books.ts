    ...
    copy: {
      ru: {
        ...
        about: [
          ...
          "В книге 114 страниц формата 21,6 на 27,9 см и 111 разных рисунков. Все они нарисованы от руки, ни один не повторяется. Под каждым рисунком написано его название крупными контурными буквами, которые тоже можно раскрасить. Получается 111 рисунков и 111 первых слов.",
