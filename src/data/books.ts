...

  {
    ...
    copy: {
      ru: {
        ...
        fitLead:
          "Возраст здесь ориентир, а не строгая граница. Двое детей одного возраста могут иметь совершенно разный опыт рисования, поэтому лучше смотреть на то, что ребенок уже умеет.",
        fitYes: [
          "Ребенок впервые берет в руки мелок или карандаш",
          "Он пытается раскрашивать, но часто выходит за контур",
          "Обычные раскраски кажутся ему слишком сложными",
          "Он быстро теряет интерес к картинкам с большим количеством деталей",
          "Вы хотите, чтобы во время раскрашивания ребенок одновременно видел написанное слово",
        ],
        fitNo: [
          "Ребенок уже уверенно раскрашивает внутри контура и справляется с мелкими деталями",
          "Ему хочется более подробных рисунков",
          "Он хочет рисовать сам, а не раскрашивать готовые картинки: тогда подойдут «Как нарисовать 111» или «Как нарисовать все на свете»",
        ],
        about: [
