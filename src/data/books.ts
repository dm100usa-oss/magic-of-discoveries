...

  {
    ...
    copy: {
      ru: {
        ...
        fitYes: [
          "Ребенок только начинает интересоваться мелками, карандашами и раскрашиванием",
          "Это его первая раскраска или раньше он раскрашивал совсем немного",
          "Ребенок рисует свободными линиями и штрихами и пока не старается оставаться внутри контура",
          "Он уже пытается раскрашивать картинки, но часто выходит за контур",
          "Ему легче раскрашивать один крупный предмет, чем картинку с множеством мелких деталей",
          "Обычные раскраски пока кажутся ему слишком сложными",
          "Ребенок быстро устает или теряет интерес, если рисунок требует слишком много точных движений",
          "Ему нравятся простые и легко узнаваемые изображения животных, транспорта, еды и других знакомых предметов",
          "Вы хотите не только раскрашивать, но и называть предметы вместе с ребенком и знакомить его с написанными словами",
          "Вам нужна раскраска, которую можно использовать постепенно: сначала для первых штрихов, а позже для более аккуратного раскрашивания внутри контура",
        ],
        fitNo: [
