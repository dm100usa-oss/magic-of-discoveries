...
const ru: Review[] = [
  {
    text: "Отличная книга. Для трехлетней дочки, наверное, еще рановато, но подождать несложно. Внутри очень много рисунков по шагам, которые можно обводить, от морских животных до еды. Обещает много веселья.",
    who: "Dmitriy Parmenov, 19 июня 2024, США",
    stars: 5,
    translated: true,
  },
  {
    text: "Это уже вторая раскраска, которую мы у них купили. Дети ее очень любят, а книга легкая, ее удобно брать с собой. Иногда мы вырезаем одну-две готовые страницы, ставим дату и оставляем на память.",
    who: "Valentina Sh, 24 мая 2024, США",
    stars: 5,
    translated: true,
  },
  {
    text: "Хорошее качество и много разных рисунков. За эти деньги получаешь целую гору картинок для раскрашивания, книга довольно толстая. Покупала в подарок ребенку подруги, ему три года, и он был очень рад.",
    who: "Danil, 8 июня 2024, Великобритания",
    stars: 5,
    translated: true,
  },
  {
    text: "Отлично подошла трехлетнему. Ему нравятся крупные формы и добрые мордочки. Раскрашивать легко, и выбор большой: от русалки до подводной лодки и пончика.",
    who: "Anna, 11 июня 2024, США",
    stars: 5,
    translated: true,
  },
];
...
const bookReviews: Record<string, { en: Review[]; es: Review[]; ru?: Review[] }> = {
  ...
  "take-a-break-animals": {
    ...
    ru: [
      ...
      {
        text:
          "Рисунки правда милые и простые, раскрашивать легко и приятно. Книга подойдет любому возрасту.",
        who: "Hanna Antoniv, 18 ноября 2024, США",
        stars: 5,
        translated: true,
      },
      {
        text:
          "Много симпатичных рисунков для раскрашивания. Подходит по возрасту. Хороший размер. Ребенок в восторге!",
        who: "GEO, 26 сентября 2024, США",
        stars: 5,
        translated: true,
      },
      {
        text:
          "Эта раскраска стала у нас любимым семейным занятием. Каждый, и взрослые, и дети, нашел в ней что-то свое. Рисунки простые, поэтому процесс в радость всем.",
        who: "Veronika, 24 сентября 2024, США",
        stars: 5,
        translated: true,
      },
      {
        text:
          "Рисунки такие милые и веселые, что хочется раскрашивать их снова и снова. Особенно понравилось, что печать односторонняя, это правда удобно.",
        who: "Regular customer, 22 сентября 2024, США",
        stars: 5,
        translated: true,
      },
    ],
  ...
  "take-a-break-ocean": {
    ...
    ru: [
      {
        text:
          "Я просто обожаю эту раскраску. Морские животные и пляжные виды приятно раскрашивать. Я покупаю много раскрасок, и эта точно одна из любимых.",
        who: "Dorotha, 13 октября 2024, США",
        stars: 5,
        translated: true,
      },
      {
        text:
          "Нравится, что рисунки простые и легко раскрашиваются, но при этом каждый выглядит очень стильно.",
        who: "Olha Elsafti, 4 сентября 2024, США",
        stars: 5,
        translated: true,
      },
      {
        text:
          "Очень классная книга. Большой формат, красиво и четко нарисованные картинки, плотные белые листы. Купила трехлетнему внуку, он с удовольствием их раскрашивал.",
        who: "Lumia, 13 сентября 2024, США",
        stars: 5,
        translated: true,
      },
    ],
  ...
  "first-coloring-book-111": {
    ...
    ru: [
      {
        text:
          "У старших детей раскраски посложнее, а годовалой дочке нужно было что-то свое. Формы на страницах простые, не перегруженные, и она может закрашивать их как угодно. Линия толстая, ей так легче.",
        who: "Adam Smith, 30 сентября 2024, США",
        stars: 5,
        translated: true,
      },
      {
        text:
          "Мой сын, ему 22 месяца, обожает эту книгу. Любит листать страницы и спрашивать про каждое животное. Рисунки милые и мультяшные, но деталей хватает, чтобы он их различал.",
        who: "TeriyakiChicken, 30 сентября 2024, США",
        stars: 5,
        translated: true,
      },
      {
        text:
          "Простые и крупные рисунки отлично подходят малышам, которые только начали брать карандаши. В книге много разных тем, и от этого раскрашивать интереснее. Нам нравится раскрашивать вместе.",
        who: "Ilia M, 24 сентября 2024, США",
        stars: 5,
        translated: true,
      },
    ],
  ...
  "how-to-draw-111": {
    ...
    ru: [
      {
        text:
          "Сын в восторге от того, насколько простые здесь инструкции, и особенно от того, что свои шедевры можно сразу раскрасить. Вижу, как с каждым новым рисунком у него прибавляется уверенности.",
        who: "Victor Borsci, 7 сентября 2024, США",
        stars: 5,
        translated: true,
      },
      {
        text:
          "Обводка по пунктиру заняла моего ребенка дольше, чем я рассчитывала. Короткие интересные факты то тут, то там - приятное дополнение.",
        who: "Valentina Sh, 13 мая 2024, США",
        stars: 5,
        translated: true,
      },
      {
        text:
          "Ребенок осваивает новое сам и любит показывать свои работы. Хотелось бы побольше животных, но в целом книга отличная.",
        who: "Layla Saunders, 1 ноября 2024, США",
        stars: 5,
        translated: true,
      },
    ],
...
export function reviewsForBook(bookId: string, lang: UiLang): Review[] {
  const key = bookId.replace(/-(en|es|ru)$/, "");
